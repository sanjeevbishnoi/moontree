...
class __$$_TransactionDetailCopyWithImpl<$Res>
  ...
  __$$_TransactionDetailCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$_TransactionDetail));

  @override
  _$_TransactionDetail get _value => super._value as _$_TransactionDetail;
...
class _$_TransactionDetail implements _TransactionDetail {
  ...
  @override
  String toString() {
    return 'TransactionDetail(txId: $txId, type: $type, sentReceived: $sentReceived, amount: $amount, confirmations: $confirmations, date: $date, fullName: $fullName, assetType: $assetType, name: $name, fees: $fees, ipfsHash: $ipfsHash, note: $note, memo: $memo)';
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(ipfsHash),
...
abstract class _TransactionDetail implements TransactionDetail {
  const factory _TransactionDetail(
      ...
      required final IpfsHash ipfsHash,
